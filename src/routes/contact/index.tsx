    ...
    return (
        <div className="max-w-7xl mx-auto py-16">
            <SectionTitle
                ...
                subtitle="Have questions, ideas, or need support? Connect with us."
            />
                        ...
                        <div className="mt-4">
                            <Accordion type="single" collapsible>
                                <AccordionItem value="item-1">
                                    ...
                                    <AccordionContent>
                                        <p className="text-sm text-muted-foreground">
                                            ...
                                            impact through community-driven
                                ...
                                <AccordionItem value="item-2">
                                    ...
                                    <AccordionContent>
                                        <p className="text-sm text-muted-foreground">
                                            Donations support program delivery,
                                ...
                                <AccordionItem value="item-3">
                                    ...
                                    <AccordionContent>
                                        <p className="text-sm text-muted-foreground">
                                            Yes — we welcome volunteers. Please
                                            reach out via the contact form with
                                ...
                                <AccordionItem value="item-4">
                                    ...
                                    <AccordionContent>
                                        <p className="text-sm text-muted-foreground">
                                            ...
                                            spreading awareness, or partnering
                                            with us for events and programs.
                                        </p>
                                    </AccordionContent>
                                </AccordionItem>
